...
public class PostController {
   ...
   public ResponseEntity<PostListUserFollowedDTO> getListPost(@PathVariable Integer userId) {
      return new ResponseEntity<>(iPostService.getListPostFollowed(userId), HttpStatus.OK);
   }
}
